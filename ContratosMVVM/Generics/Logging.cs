...
namespace ContratosMVVM.Generics
{
    public sealed class Logger
    {
        ...
        public static bool IgnoreDebug = true;
        ...
        /// <summary>
        /// Logs a debug message if "IgnoreDebug" is set as true
        /// </summary>
    ...
    public sealed class LogMessageInfo : EventArgs
    {
        ...
        public bool IsError => Generics.Logger.ERROR.Equals(Level, StringComparison.Ordinal);
        public bool IsWarning => Generics.Logger.WARN.Equals(Level, StringComparison.Ordinal);
        public bool IsInformation => Generics.Logger.INFO.Equals(Level, StringComparison.Ordinal);
        public bool IsDebug => Generics.Logger.DEBUG.Equals(Level, StringComparison.Ordinal);
